        ...
        this.each(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        url: 'https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20weather.forecast%20where%20woeid=' + woeid + '%20and%20u%3D"c"&format=json&diagnostics=true&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys&callback=?',
                        dataType: "json",
                        success: function (data) {
                            ...
                            for (var i = 0; i < data.query.results.channel.item.forecast.length && i < days; i++) {
                                ...
                                if (i == 0) {
                                    ...
                                    high = "<p class='highTemp'> High: " + data.query.results.channel.item.forecast[i].high + " &deg;C</p>";
                                    low = "<p class='lowTemp'> Low: &nbsp;" + data.query.results.channel.item.forecast[i].low + " &deg;C</p>";
                                    ...
                                    date = "<p>" + data.query.results.channel.item.forecast[i].date + "</p>";
                                    image = "<img src='" + codeImgURL + data.query.results.channel.item.forecast[i].code + ".png'/>";
                                    high = "<span class='highTemp'> H: " + data.query.results.channel.item.forecast[i].high + " &deg;C</span>";
                                    low = "<span class='lowTemp'> L: " + data.query.results.channel.item.forecast[i].low + " &deg;C</span>";
                                    description = "<p>" + data.query.results.channel.item.forecast[i].text + "</p>";
